...
const Index = () => {
  ...
  useEffect(() => {
    document.title = "BidSushi | Forgot Password";
    if (user) {
  ...
  const onSubmitHandler = (e) => {
   ...
   let re = USER_EMAIL_REGEX;
    e.preventDefault();
    if (!emailError && email&&email.trim() && re.test(email.trim())) {
      ...
      bidShushi
        ...
        .then((r) => {
          setDisable(false);
          navigate(RoutesConstant.forgotPasswordSuccess);
        })
        .catch((err) => {
          console.log(e);
          setDisable(false);
       //   navigate(RoutesConstant.forgotPasswordSuccess);
          if(err?.message==='Your Account is not active. Kindly contact support.'){
            api.error({
              message: `Error`,
              description: 'Invalid email address or this account may be inactive.',
              placement: 'topRight'
            })
          }else{
            navigate(RoutesConstant.forgotPasswordSuccess);
          ...
          <div className="login-form-wrapper mt-3">
            ...
            <form onSubmit={onSubmitHandler}>
              <div className="form-group">
                <label>
                  ...
                  <i className="float-end">
                    <img alt="logo" src="/images/user-icon.png" />{" "}
                  </i>{" "}
                </label>
                <input
              ...
              <div className="col-md-12 text-end">
                <Link to={RoutesConstant.login} className="small">
                  Back to login?
                </Link>
              </div>
              <button
